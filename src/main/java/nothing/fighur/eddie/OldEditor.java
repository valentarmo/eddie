...
public class OldEditor
{
    ...
    private OldEditor(Terminal terminal) throws IOException
    {
    ...
    private OldEditor(Terminal terminal, String filePath) throws IOException
    {
        starting = true;
        this.terminal = terminal;
        this.text = new Text(tabstop);
    ...
    public static OldEditor createEmpty(Terminal terminal) throws IOException
    { return new OldEditor(terminal); }

    public static OldEditor createWithFile(Terminal terminal, String filePath) throws IOException
    { return new OldEditor(terminal, filePath); }
